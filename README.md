...
<div align="left" witdh="45%">
	<img width="45%" src="readme_images/survey_results_phantom.png" alt="qualitative results"
	title="qualitative results">
</div>
<div align="right" witdh="45%">
	<img width="45%" src="readme_images/survey_results_patient.png" alt="qualitative results"
	title="qualitative results">
</div><br>
